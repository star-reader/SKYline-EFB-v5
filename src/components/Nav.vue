  ...
  <div>
      ...
      <div class="title">
        ...
        <div id="left-icon">
          ...
          <div class="search-box">
            <el-input placeholder="输入搜索内容" prefix-icon="el-icon-search" @keyup.enter.native="searchStart"
              v-model="search_word">
            </el-input>
          </div>
          <el-tooltip class="item" effect="dark" content="创建飞行计划" placement="right">
            <a @click="openFlightPlan" style="z-index: 12;"><i style="font-size:25px"
      ...
      <div class="action">
        <div>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item id="jeppesen" @click.native="selectMap('jeppesen')">Navigraph
                Jeppesen高空图层</el-dropdown-item>
        ...
        <div>
          <el-tooltip class="item" :id="simLinkActive()" effect="dark" content="启动SKYline FlightLink"
          ...
          <el-tooltip class="item" effect="dark" content="个人信息" placement="bottom">
            <div @click="showPersonalCard">
              ...
              <div v-if="personalData.authorizedUser" class="authorized-area">
                <img width="100%" v-if="personalData.authorizedUser == 'developAuthorize'" class="auth"
                  :src="authorize_icon" alt="Authorized">
    ...
    <div class="personal-card">
      ...
      <div v-if="personalData.authorizedUser" class="authorized-area-main">
        <img width="100%" class="auth" v-if="personalData.authorizedUser == 'developAuthorize'" :src="authorize_icon"
          alt="Authorized">
        <i class="auth el-icon-star-on" v-if="personalData.authorizedUser == 'personalAuthorize'"></i>
      </div>
      ...
      <div class="auth-data">
        <div class="icon">
          <div v-if="personalData.authorizedUser" class="authorized-area-2">
            <img width="100%" class="auth" v-if="personalData.authorizedUser == 'developAuthorize'"
              :src="authorize_icon" alt="Authorized">
            <i class="auth el-icon-star-on" v-if="personalData.authorizedUser == 'personalAuthorize'"></i>
          </div>
        </div>
    ...
    <el-card class="upload">
      ...
      <el-upload class="upload-demo" drag accept="image/*" :before-upload="changeFile"
        action="https://upload.api.skylineflyleague.cn/avatar?type=1" :limit="1">
